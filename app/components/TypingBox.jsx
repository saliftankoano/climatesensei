    ...
    <div className="z-10 max-w-[600px] flex space-y-6 flex-col bg-gradient-to-tr  from-slate-300/30 via-gray-400/30 to-slate-600-400/30 p-4  backdrop-blur-md rounded-xl border-slate-100/30 border">
      <div>
        <h2 className="text-white font-bold text-xl">
          Helping you learn about climate
        </h2>
        <p className="text-white/65">
          Ask us about anything related to climate change. For example: What
          pollutes the most in NYC?
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="gap-3 flex">
          <input
            ...
            placeholder="What polutes the most in NYC?"
            value={question}
